...
CONCEPT="Graphs"
UNOPT_DS="Edge list scanned repeatedly"
OPT_DS="Adjacency list with BFS"
UNOPT_HOW="Every traversal step scans all edges to discover neighbors"
OPT_HOW="Neighbors are pre-grouped per node, so traversal only touches relevant edges"
UNOPT_COMPLEXITY="Repeated global edge scans dominate query time"
OPT_COMPLEXITY="Traversal scales with visited nodes and connected edges"
