...
UNOPT_DS="Bubble sort"
OPT_DS="Introspective sort via std::sort"
UNOPT_HOW="Repeated adjacent swaps traverse the array many times"
OPT_HOW="Library sort uses hybrid strategy with strong average and worst-case behavior"
UNOPT_COMPLEXITY="Quadratic comparison growth dominates large inputs"
OPT_COMPLEXITY="Near O(n log n) behavior for this dataset"
