...
UNOPT_DS="Vector used as queue with front erase"
OPT_DS="Queue with std::deque and undo stack"
UNOPT_HOW="Removing from front shifts remaining tickets each cycle"
OPT_HOW="Deque pops front efficiently and stack stores recent actions"
UNOPT_COMPLEXITY="Front erase cost accumulates under sustained throughput"
OPT_COMPLEXITY="Queue and stack operations stay stable under repetition"
