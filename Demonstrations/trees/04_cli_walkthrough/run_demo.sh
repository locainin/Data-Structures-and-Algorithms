...
CONCEPT="Trees"
UNOPT_DS="Flat vector scan"
OPT_DS="Ordered tree map via std::map"
UNOPT_HOW="Each product lookup checks many entries sequentially"
OPT_HOW="Tree ordering supports logarithmic key search and bounded range scans"
UNOPT_COMPLEXITY="Lookup cost grows linearly with catalog size"
OPT_COMPLEXITY="Lookup and range start are logarithmic in key count"
